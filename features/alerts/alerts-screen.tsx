      ...
      <div className="alerts-layout">
        <section className="surface rule-composer">
          ...
          <form onSubmit={submitRule}>
            ...
            <fieldset className="delivery-mode"><legend>Delivery mode</legend><label><input type="radio" name="mode" value="six_hour" checked={mode === "six_hour"} onChange={() => setMode("six_hour")} /><span><strong>Every 6 hours</strong><small>Best for active searches</small></span></label><label><input type="radio" name="mode" value="daily_digest" checked={mode === "daily_digest"} onChange={() => setMode("daily_digest")} /><span><strong>Daily digest</strong><small>One concise review</small></span></label></fieldset>
